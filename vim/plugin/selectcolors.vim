...
" mostly based on Version 2010-09-12 from http://vim.wikia.com/wiki/VimTip341
" modified by blastmaster
" Press key:
"   F8                next scheme
...
let s:current = 1   " remember index of currently used colorscheme
...
function! s:SetColors(args)
  ...
  elseif a:args == 'my'
    "TODO: set to something i really use

...
" General
" hi Normal        ctermfg=232  guifg=#080808  ctermbg=252  guibg=#fff299  cterm=none  gui=none
hi Normal        ctermfg=232  guifg=#080808  ctermbg=252  guibg=#dddddd  cterm=none  gui=none
...
hi LineNr        ctermfg=238  guifg=#323232  ctermbg=bg   guibg=#bbbbbb  cterm=none  gui=bold
hi NonText       ctermfg=238  guifg=#444444  ctermbg=bg   guibg=bg       cterm=bold  gui=bold
hi SpecialKey    ctermfg=239  guifg=#4e4e4e  ctermbg=250  guibg=bg       cterm=bold  gui=bold
hi Title         ctermfg=254  guifg=#638000  ctermbg=167  guibg=bg       cterm=none  gui=bold
...
" Syntax
hi Identifier    ctermfg=52   guifg=#5f0000  ctermbg=bg   guibg=bg       cterm=none  gui=bold
hi Statement     ctermfg=28   guifg=#5566dd  ctermbg=bg   guibg=bg       cterm=bold  gui=bold
hi Type          ctermfg=25   guifg=#e59900  ctermbg=bg   guibg=bg       cterm=bold  gui=bold
hi Constant      ctermfg=160  guifg=#df0000  ctermbg=bg   guibg=bg       cterm=none  gui=none
hi String        ctermfg=23   guifg=#c43704  ctermbg=bg   guibg=bg       cterm=none  gui=none
hi Function      ctermfg=23   guifg=#8f6b32  ctermbg=bg   guibg=bg       cterm=none  gui=none
...
hi Comment       ctermfg=241  guifg=#00ac00  ctermbg=bg   guibg=bg       cterm=none  gui=none
hi Todo          ctermfg=254  guifg=#bf0361  ctermbg=166  guibg=#6193cf  cterm=none  gui=bold
